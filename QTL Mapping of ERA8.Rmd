...
Add columns to the GBS data to give unique positions per chromosome for graphing purposes only. 
```{r}
...
Traits: E1D1	E1D2	E1D3	E1D4	E1D5	E1GI	E2D1	E2D2	E2D3	E2D4	E2D5	E2GI	E3D1	E3D2	E3D3	E3D4	E3D5	E3GI
...
QTL Graph 
```{r  warning=FALSE, message=FALSE}
QTL.LZ8.ERA8<-read.table("LZ8_QTL_GBS.txt",header=TRUE,na.string=c("", " ", "NA", "na"))
ggplot(QTL.LZ8.ERA8, aes(x=QTL.LZ8.ERA8$order, y=QTL.LZ8.ERA8$lod))+
  geom_point(aes(colour = factor(Genome)),size = 2)+ylim(0,6)+theme_bw()+ theme(axis.text = font,  axis.title = font, axis.text.x=element_blank())+ scale_color_manual(values=c("#0A0A0A", "#8A8A8A", "#D1D1D1","#8B4500"))+ 
...
```{r  warning= FALSE, message=FALSE}
# write.table(out.cimHeading, "./QTLheadingLZ8.txt", sep="\t")
QTLheadingLZ8<-read.table("./LZ8_QTL_heading.txt",header=TRUE,na.string=c("", " ", "NA", "na"))
...
ggplot(QTLheadingLZ8, aes(x=QTLheadingLZ8$order, y=QTLheadingLZ8$lod))+
  ...
  scale_color_manual(values=c("#0A0A0A", "#8A8A8A", "#D1D1D1","#000000"))+ geom_hline(aes(yintercept = 4.4))+ 
  labs(x = "Chromosome 1A - 7D and Unknown" , y = "LOD", title="Heading Date QTL")

# write.table(out.cimHeight, "./QTLheightLZ8.txt", sep="\t")
QTLheightLZ8<-read.table("./LZ8_QTL_height.txt",header=TRUE,na.string=c("", " ", "NA", "na"))
...
QTL.LZ8<-read.table("./LZ8_QTL_GBS_ABAHeadHei.txt",header=TRUE,na.string=c("", " ", "NA", "na"))
...
QTL.LZ8.4A<-read.table("./LZ8_QTL_GBS_ABAHeadHei_4A.txt",header=TRUE,na.string=c("", " ", "NA", "na"))
